...
def get_census_zcta(var_name, var_entry, year):
    ...
    if 'den' in var_entry:
        ...
        data = c.sf1.state_zipcode(all_var_list, Census.ALL, Census.ALL)
    ...
    df.rename(columns={'zip code tabulation area (or part)':'zcta'}, inplace = True)
